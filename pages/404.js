...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 flex flex-col transition-colors">
      ...
      {/* 404 */}
      <p className="text-8xl font-extrabold text-gray-200 dark:text-gray-800 leading-none select-none">404</p>
      ...
      {/* Donation box */}
      <div className="mt-10 w-full max-w-xs bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6">
        <p className="text-sm font-semibold text-orange-500 uppercase tracking-widest mb-1">Support Our Community</p>
        ...
        <div className="flex items-center bg-white dark:bg-gray-900 rounded-xl overflow-hidden border border-gray-300 dark:border-gray-700 focus-within:border-orange-400 transition-colors">
          ...
          <input
            ...
            className="flex-1 bg-transparent px-2 py-3.5 text-gray-900 dark:text-white text-lg font-semibold placeholder-gray-300 dark:placeholder-gray-600 outline-none"
          />
        </div>
        ...
        <p className="mt-3 text-xs text-gray-400 dark:text-gray-500">501(c)(3) · Tax-deductible · Powered by Stripe</p>
      </div>
