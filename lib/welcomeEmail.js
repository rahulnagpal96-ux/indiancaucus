  ...
  <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;width:100%;">
    ...
    <tr>
      <td style="background:#111d35;border-radius:0 0 16px 16px;padding:28px 40px;text-align:center;">
        ...
        <p style="margin:0;color:#334155;font-size:11px;">You are receiving this because you subscribed at indiancaucus.org. To unsubscribe, reply with &ldquo;unsubscribe&rdquo; to this email.</p>
      </td>
    </tr>
