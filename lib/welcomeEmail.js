  ...
  <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;width:100%;">
    ...
    <tr>
      <td style="background:#ffffff;padding:40px 40px 32px;">
        <h1 style="margin:0 0 16px;color:#1a2744;font-size:26px;font-weight:800;line-height:1.2;">Welcome, ${name}.</h1>
      ...
      <td style="background:#ffffff;padding:32px 40px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:20px;">
          <tr>
            ...
            <td style="padding-left:16px;">
              ...
              <p style="margin:0 0 6px;color:#6b7280;font-size:13px;">Buchmuller Park, 150 Plaza Center, Secaucus NJ 07094</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:20px;">
          <tr>
            ...
            <td style="padding-left:16px;">
              <p style="margin:0 0 2px;color:#1a2744;font-size:15px;font-weight:700;">Dandiya Dhamaka &mdash; October 24, 2025</p>
              <p style="margin:0 0 6px;color:#6b7280;font-size:13px;">Secaucus Recreation Center, 1200 Koelle Blvd, Secaucus NJ 07094</p>
