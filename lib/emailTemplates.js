  ...
  return `
    <tr>
      <td style="background:#111d35;border-radius:0 0 16px 16px;padding:28px 40px;text-align:center;">
        ...
        <p style="margin:0;color:#334155;font-size:11px;">You are receiving this as a subscriber. <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#475569;text-decoration:underline;">Unsubscribe</a></p>
      </td>
    </tr>`
}
